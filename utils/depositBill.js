  ...
  return `
                    ...
                    <div class="section">
                            ...
                            <table class="info-table">
                                    ...
                                    <tr>
                                            ...
                                            <td>${
                                              receipt.patientDetails.name
                                            }</td>
                                    </tr>
                                    <tr>
                                            <td class="info-label">Age & Gender</td>
                                            <td>${
                                              receipt.patientDetails.age
                                            } years / ${
    receipt.patientDetails.gender
                                    ...
                                    <tr>
                                            ...
                                            <td>${
                                              receipt.patientDetails.contact
                                            }</td>
                                    </tr>
                                    <tr>
                                            <td class="info-label">OPD | IPD Number</td>
                                            <td>${
                                              receipt.patientNumbers
                                                ?.opdNumber || "N/A"
                                            } | ${
                    ...
                    <div class="section">
                            ...
                            <table class="info-table">
                                    ...
                                    <tr>
                                            ...
                                            <td>${getCurrentIndianTime()}</td>
                                    </tr>
                                    <tr>
                                            <td class="info-label">Generated By</td>
                                            <td>${
                                              receipt.receiptDetails.generatedBy
                                                .userName
                                            } (${
